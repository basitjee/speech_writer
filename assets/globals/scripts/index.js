var Index = {
	...
	createMap: function () {
		...
		var locations = [['Team Fox', 'undefined', 'undefined', 'undefined', 'undefined', 41.3850639, 2.1734034999999494, '../../assets/globals/img/map-marker-ellipse-blue.png']];
		...
		google.maps.event.addListener(searchBox, 'places_changed', function() {
			...
			for (var i = 0, place; place = places[i]; i++) {
				...
				var marker = new google.maps.Marker({
					map: map,
					icon: '../../assets/globals/img/map-marker-ellipse-blue.png',
					title: place.name,
