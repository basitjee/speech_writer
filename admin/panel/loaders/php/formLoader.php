...
class formLoader {
	...
	private function element_single_line_text($field)
	{
		...
		$html .= "Special Keyword for this field {".$this->make_label($id, $field->title, $required)."}<br> Please put the value in textbox that will appear as default text to this textbox";
