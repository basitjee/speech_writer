...
<head>
	...
	<title>Speech Writer - Craft Speech</title>
...
function load_sub_speech(id) {
	$.ajax({ url: 'sub_speech_drop_down.php',
	         data: {action: id},
	         type: 'post',
	         success: function(output) {
	         			$("#sub_speech_wrapper").show();
	         			$("#sub_speech_container").html(output);	                      
	                  }
	});	
}
</script>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content bg-blue-grey">
			<div class="row">
				<div class="col-sm-6">
					<h1>Craft Speech <small></small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
						...
						<li><a href="create_speech.php" class="active">Craft Speech</a></li>
					</ol>
				</div><!--.col-->
			</div><!--.row-->
		</div><!--.page-header-->		 
			...
			<div class="col-md-12">
				<div class="panel">
					<div class="panel-heading">
						<div class="panel-title"><h4>Craft Speech</h4></div>
					</div><!--.panel-heading-->
					<div class="panel-body">

						<form name="main_speech_form" action="speech_builder.php" method="post" class="form-horizontal" enctype="multipart/form-data">							 
							<div class="form-group has-success has-feedback">
									...
									<div class="col-md-5">
										<div class="inputer">
											...
											?>	
												<select name="main_speech" id="main_speech" class="selecter" required="required" onchange="load_sub_speech(this.value)" >
													<option value="" selected="selected">Select One</option>
													<?php
														while ($row = mysql_fetch_array($result_main_speech)) {															 														    
														    echo "<option value='" . $row['id'] . "' >" . $row['speech_title'] . "</option>";
														}
													?>
												</select>
											</div>
								...
								<div class="form-group has-success has-feedback" id="sub_speech_wrapper" style="display: none;" >
									<label class="control-label col-md-3" for="inputSuccess2">Sub Speech</label>
									<div class="col-md-5">
										<div class="inputer">
											<div class="input-wrapper" id="sub_speech_container">
							...
							<div class="form-actions">
									<div class="row">
										<div class="col-md-offset-3 col-md-9">											
											<button type="submit" class="btn btn-primary">Start Speech Generation Process</button>
