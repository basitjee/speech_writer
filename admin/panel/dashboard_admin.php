...
<head>
	...
	<title>Speech Writer - Admin Panel</title>
...
<body>
	...
	<div class="content">
		...
		<div class="page-header full-content">
			<div class="row">
				<div class="col-sm-6">
					<h1><!--<img src="../../assets/globals/img/shop-1424339975.jpg" width="150">-->Admin Panel || Speech Writer<small></small></h1>
				</div><!--.col-->
				<div class="col-sm-6">
					<ol class="breadcrumb">
		...
		<div class="display-animation">
			...
			<div class="row image-row" style="border:1px solid #000;">
				<img src="../../assets/globals/img/background-11.jpg" width="1200" height="700" >
			</div><!--.row-->
