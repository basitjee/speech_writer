...
// print_r($step_pieces);
	...
	if (strpos($step_pieces[0], '<input type="text"') !== false) {
		$step_content1 = '{
			"title":"'.$input_name1.'",
			"type":"element-single-line-text",
			"description": "",
			"required":'.$required_flag1.',
			"position":3
		}';		
	} else if (strpos($step_pieces[0], '<textarea name') !== false) {
		$step_content1 = '{
			"title":"'.$input_name1.'",
			"type":"element-paragraph-text",
			"description": "",
			"required":'.$required_flag1.',
			"position":3
		}';		
...
// echo $step_content1;
	...
	if ($editor_heading != "") {
		$editor_heading_content = '{
			"title":"",
			"type":"element-section-break",
			"description": "'.$editor_heading.'",
			"required":false,
			"position":1
		}'; 
	} else {
	...
	if ($editor_sub_heading != "") {
		$editor_sub_heading_content = '{
			"title":"",
			"type":"element-section-break",
			"description": "'.$editor_sub_heading.'",
			"required":false,
			"position":2
		}'; 
	} else {
	...
	if ($opening1 != "") {
		$opening1_content = '{
			"title":"Question/Opening Statement",
			"type":"element-section-break",
			"description": "'.$opening1.'",
			"required":false,
			"position":4
		}';		
	} else {
...
// $step_content = '{ "title": "Speech Generator", "description": "", "fields": [ {} , {} , {} , {} , {} , {} , {} , { "title":"Question/Opening Statement", "type":"element-section-break", "description": "{name} it\'s been {years} since you first came here. We had to double check the calendar to make sure. It doesn\'t seem that long at all!", "required":false, "position":4 } , { "title":"Question/Opening Statement", "type":"element-section-break", "description": "When I realized that you\'ve actually been with us for {years} I was amazed. i am sure time shrinks, especially when you spend it with people whom you\'ve come to rely on.", "required":false, "position":4 } , { "title":"Question/Opening Statement", "type":"element-section-break", "description": "{name} you\'ve been part of the crew now for {years}. While we\'re grateful for that, we\'d like you to know no matter how many you\'ve given us, they\'ll never be enough.", "required":false, "position":4 } , {} , {} , {} , { "title":"Question/Opening Statement", "type":"element-multiple-choice", "description": "dss", "required":false, "position":4 } ] }';
echo $step_content;
?>