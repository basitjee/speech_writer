      ...
      <div class="left-col" id="toolbox-col" style="padding-top: 18px">
        ...
        <div class="tab-content">
          ...
          <div class="tab-pane active" style="padding: 20px;" id="add-field">
            ...
            <div class="col-sm-6">
              <button class="button grey new-element" data-type="element-section-break" style="width: 100%;">Question / Opening</button>
              <button class="button new-element" data-type="element-single-line-text" style="width: 100%;">Single Line Text Field</button>
