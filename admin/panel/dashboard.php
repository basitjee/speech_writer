			...
			<div class="full-content margin-top-40 margin-bottom-40 bg-white">
				<div class="row">
					...
					<div class="col-md-4 material-animate padding-right-40">
						<h4>Welcome</h4>
						<p class="text-grey">
							<strong>Your balance is: <?=$balance?> SEK</strong>
							<br/>
							<strong>Your customer number is: <?=$_SESSION['user_id']?> </strong>			
				...
				<div class="col-md-4">
					...
					<div class="card tile card-dashboard-info card-light-blue material-animate">
						<div class="card-body">
							...
							<p class="result"><a href="buy_new_card.php">Lyca, Comivq, Delight,Telia,Telenor,Halibop, Idt and lycatel</a></p>
				...
				<div class="col-md-4">
					<div class="card tile card-friend material-animate">
						...
						<div class="friend-content">
							<p class="title"><a href="buy_new_card.php">Buy New Card</a></p>
							<!--<p><a href="user-profile.html">Stockholm</a></p> -->
							<a href="buy_new_card.php" class="btn btn-flat btn-primary btn-xs">Enter</a>
						</div><!--.friend-content-->
					</div><!--.card-->
					...
					<div class="card tile card-friend material-animate">
						...
						<div class="friend-content">
							<p class="title"><a href="money_transfer.php">Request Money Transfer</a></p>
							<!-- <p><a href="user-profile.html">Halmstad</a></p> -->
							<a href="money_transfer.php" class="btn btn-flat btn-primary btn-xs">Enter</a>
						</div><!--.friend-content-->
					</div><!--.card-->
					...
					<div class="card tile card-friend material-animate">
						...
						<div class="friend-content">
							<p class="title"><a href="request_balance.php">Load Balance</a></p>
							<!-- <p><a href="user-profile.html">Angered</a></p> -->
							<a href="request_balance.php" class="btn btn-flat btn-primary btn-xs">Enter</a>
						</div><!--.friend-content-->
					</div><!--.card-->
					...
					<div class="card tile card-friend material-animate">
						...
						<div class="friend-content">
							<p class="title"><a href="transaction_history.php">Transaction History</a></p>
							<!-- <p><a href="user-profile.html">Angered</a></p> -->
							<a href="transaction_history.php" class="btn btn-flat btn-primary btn-xs">Enter</a>
						</div><!--.friend-content-->
					</div><!--.card-->
				</div><!--.col-->
